...
| 9 | Canales Adicionales | ✅ Completado (revisión pendiente del PR #32) | Fase 2. Telegram y Email (#25), Whisper (#26), unificación de contactos (#27), `/vincular` (#29), Webchat WebSocket (#30), despliegue de la migración 009 (#31), cola `media` (#32). Pendientes menores en revisión: `answerCallbackQuery`/throttling de Telegram (PR #34), adjuntos de email (PR #35), widget JS del Webchat (ADR-063, este PR). PR #28 de Dev B cerrado como duplicado; lo que aportaba (tests de integración de la transcripción) va en #33 |
