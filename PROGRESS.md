...
| 9 | Canales Adicionales | ✅ Completado (revisión pendiente de PRs #34/#35/#36) | Fase 2. Telegram y Email (#25), Whisper (#26), unificación de contactos (#27), `/vincular` (#29), Webchat WebSocket (#30), despliegue de la migración 009 (#31), cola `media` (#32), tests de transcripción (#33). Pendientes menores cerrados: `answerCallbackQuery`/throttling de Telegram (PR #34, CI verde), adjuntos de email (PR #35, CI verde), widget JS del Webchat (PR #36, ADR-063, CI verde) — a la espera de confirmación para mergear. PR #28 de Dev B cerrado como duplicado. Auditoría general de seguridad (fuera del sprint): BUG-041 encontrado y cerrado — `/auth/refresh` no revalidaba usuario/tenant activos contra la base |
