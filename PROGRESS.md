...
- **Fase:** 1 — MVP Core
- **Sprint Activo:** Sprint 8 — Observabilidad, Backup & Hardening (Dev B mergeado en [PR #18](https://github.com/miguelggdev/Omnichannel-Platform/pull/18); **Dev A entregado en la rama `feature/sprint-08-observability`**, pendiente de PR y merge)
...
| 8 | Observabilidad, Backup & Hardening | 🔄 En progreso | **Hito MVP.** Dev B (PR #18, mergeado): auditoría por trigger, RGPD, quick replies, backup/restore y el test e2e; BUG-025 cerrado con `auth_lookup_user()`. Dev A (rama `feature/sprint-08-observability`, pendiente de PR): OpenTelemetry, Loguru, métricas, 4 dashboards, 13 alertas y cifrado pgcrypto con índice ciego; BUG-026 y BUG-003 cerrados. 670 tests unitarios. El addendum de operaciones (4 features) sigue sin asignar en la matriz |
